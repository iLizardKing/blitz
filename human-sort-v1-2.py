...
class Application:
    ...
    def create_frame1(self):
        ...
        self.option_but1 = Button(self.frame1, text="Option 1", font=self.fnt1, \
                                  width=10, state=DISABLED, command=self.choose1)
        self.option_but2 = Button(self.frame1, text="Option 2", font=self.fnt1, \
                                  width=10, state=DISABLED, command=self.choose2)
    ...
    def create_frame2(self):
        ...
        self.options_txt = Text(self.frame2, height=15, width=15, font=self.fnt2, wrap=WORD)
        self.options_txt.place(x=5, y=5)
        self.add_from_file_but = Button(self.frame2, text="Добавить из файла", \
                                        font=self.fnt2, command=self.add_from_file)
        self.add_from_text_but = Button(self.frame2, text="Добавить", \
                                        font=self.fnt2, command=self.add_from_text)
    ...
    def create_widgets(self):
        self.root = Tk()
        self.root.title(u'one-FROM-two')
    ...
    def start(self):
        if len(self.list_objects) > 1:
            ...
            self.temp_question = -1, -1
            self.human_sort()
            self.quest_num_lab['text'] = self.quest_num_lab['text'][:24] + \
